...
**[Blog-App]** is a website that will show the list of posts and empower readers to interact with them by adding comments and liking posts.
...
```sh
  cd blog
  git clone https://github.com/jdbs9514/blog.git
```
